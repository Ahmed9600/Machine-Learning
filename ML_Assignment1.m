...
T = read(ds);
TrainingSet = T(1:10800,:); %60% of the data for training
CrossValidationSet = T(10801:14401,:); %20% for cross validation test
TestSet = T(14402:17999,:); %20% for the test set
size(T);
Alpha=.05;
;
m=length(T{:,1});
